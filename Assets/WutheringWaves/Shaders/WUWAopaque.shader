Shader "WUWA/Opaque"
{
    Properties
    {
        ...
        _LightStrength("Light Strength", float) = 3.4
        _AlphaStrength("Alpha Strength", Range(0,2)) = 1.5
        ...
        Pass
        {
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                WUWABodyShader(
                    ...
                    value,
                    influence);
                float4 finalColor = float4(value,1.0);
...
/*
        ...
        /*Pass
        {
            ...
            inline half3 LerpWhiteTo(half3 b, half t)
            {
                return lerp(1.0h, b, t); // 1.0h 表示 white
            }
